...
const CPUInstruction instructions[] = {
    ...
    {"INV", 0x02, INVALID_ADDRS},
    {"INV", 0x03, INVALID_ADDRS},
#if SIMULATE_W65C02S
    {"TSB", 0x04, ZP_ADDRS,                      2, 5, TSB_ins_},  // TSB: Test and Set memory Bit
#else
    {"INV", 0x04, INVALID_ADDRS},
#endif
...
#if SIMULATE_W65C02S
    {"ORA", 0x11, ZP_INDIRECT_ADDRS,             2, 5, ORA_ins_},  // ORA: OR Memory with Accumulator
#else
    {"INV", 0x12, INVALID_ADDRS},
#endif
    ...
    {"INV", 0x22, INVALID_ADDRS},
    {"INV", 0x23, INVALID_ADDRS},
    ...
    {"INV", 0x42, INVALID_ADDRS},
    {"INV", 0x43, INVALID_ADDRS},
    {"INV", 0x44, INVALID_ADDRS},
...
#endif
    {"INV", 0x53, INVALID_ADDRS},
    {"INV", 0x54, INVALID_ADDRS},
...
#endif
    {"INV", 0x5b, INVALID_ADDRS},
    {"INV", 0x5c, INVALID_ADDRS},
    ...
    {"INV", 0x82, INVALID_ADDRS},
    {"INV", 0x83, INVALID_ADDRS},
...
#if SIMULATE_W65C02S
    {"SMB0", 0x87, ZP_ADDRS,                     2, 3, SMB0_ins_}, // SMB0: Set Memory Bit 0
#else
    {"INV", 0x87, INVALID_ADDRS},
#endif
...
#if SIMULATE_W65C02S
    {"SMB1", 0x97, ZP_ADDRS,                     2, 3, SMB1_ins_}, // SMB1: Set Memory Bit 1
#else
    {"INV", 0x97, INVALID_ADDRS},
#endif
...
#if SIMULATE_W65C02S
    {"SMB2", 0xa7, ZP_ADDRS,                     2, 3, SMB2_ins_}, // SMB2: Set Memory Bit 2
#else
    {"INV", 0xa7, INVALID_ADDRS},
#endif
...
#if SIMULATE_W65C02S
    {"SMB3", 0xb7, ZP_ADDRS,                     2, 3, SMB3_ins_}, // SMB3: Set Memory Bit 3
#else
    {"INV", 0xb7, INVALID_ADDRS},
#endif
    ...
    {"INV", 0xc2, INVALID_ADDRS},
    {"INV", 0xc3, INVALID_ADDRS},
...
#if SIMULATE_W65C02S
    {"SMB4", 0xc7, ZP_ADDRS,                     2, 3, SMB4_ins_}, // SMB4: Set Memory Bit 4
#else
    {"INV", 0xc7, INVALID_ADDRS},
#endif
...
#endif
    {"INV", 0xd3, INVALID_ADDRS},
    {"INV", 0xd4, INVALID_ADDRS},
...
#if SIMULATE_W65C02S
    {"SMB5", 0xd7, ZP_ADDRS,                     2, 3, SMB5_ins_}, // SMB5: Set Memory Bit 5
#else
    {"INV", 0xd7, INVALID_ADDRS},
#endif
    ...
    {"INV", 0xe2, INVALID_ADDRS},
    {"INV", 0xe3, INVALID_ADDRS},
...
#if SIMULATE_W65C02S
    {"SMB6", 0xe7, ZP_ADDRS,                     2, 3, SMB6_ins_}, // SMB6: Set Memory Bit 6
#else
    {"INV", 0xe7, INVALID_ADDRS},
#endif
...
#if SIMULATE_W65C02S
    {"SMB7", 0xf7, ZP_ADDRS,                     2, 3, SMB7_ins_}, // SMB7: Set Memory Bit 7
#else
    {"INV", 0xf7, INVALID_ADDRS},
#endif
...
#endif
    {"INV", 0xfb, INVALID_ADDRS},
    {"INV", 0xfc, INVALID_ADDRS},
